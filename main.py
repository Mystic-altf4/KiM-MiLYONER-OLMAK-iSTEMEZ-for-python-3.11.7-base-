...
def soru3():
    ...
    print("A: Piçardi, B: Rafa Sapla Sigma namıdiğer LİONEL RAFA MESSİLVA (prime pessi), C: Köle Osimhen, D: Parashuayi")
...
def soru4():
    ...
    print("Soru 4: 𝑔𝑒𝓉𝓉𝒾𝓃 𝑔𝑒𝓉𝓉𝒾𝓃 𝒻𝓇𝑒𝒶𝓀𝓎 𝑜𝓃 𝒶 𝒻𝓇𝒾𝒹𝒶𝓎 𝓃𝒾𝑔𝒽𝓉 𝓎𝑒𝒶𝒽")
